...
<style type="text/css">
	...
	<body>
	<div>
	<form action="${path }admin/findAllUserinfo" id="userinfoListForm" name="ff" method="post">	
<table class="table">
<thead>
      <tr >
           <th>Id</th> <!--赛事的id--> 
     ...
     <tbody>
      ...
      <s:iterator value="pb.list" id="userinfo">	
       <tr>
	        ...
	        <td><s:property value="#userinfo.own_prizes" /></td> 
	        <td><s:property value="#userinfo.own_tel" /></td>   
	        <td><a href='#' onclick="edit(<s:property value="#userinfo.own_id"/>)">编辑</a></td>
	        <td><a href='#' onclick="del(<s:property value="#userinfo.own_id"/>)">删除</a></td>
	  </tr>
	   </s:iterator>
	  </c:if>
	  <c:if test="${empty pb.list}">
 ...
 <script type="text/javascript">
	          function fy(page)
	          {
	        	  var form=document.getElementById("userinfoListForm");
	  			 form.action="${pageContext.request.contextPath}/admin/findAllUserinfo.action?currentPage=" + page ;
	  			 form.submit();
		...
		function del(own_id){
			...
			{
			   location.href="${pageContext.request.contextPath}/admin/delUserinfo.action?own_id="+own_id;
			 }
		}
		function edit(own_id){
			location.href="${pageContext.request.contextPath}/admin/editUserinfo.action?own_id="+own_id;
		}
	</script>
	<script type="text/javascript">
